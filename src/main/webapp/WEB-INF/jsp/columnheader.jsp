						...
						<div class="card mt-30">
							...
							<div class="card-body" >
								<div class="demo-checkbox"
									...
									<input type="checkbox" id="md_checkbox_39" class="arial filled-in chk-col-info" value="Aria-required" />
									<label for="md_checkbox_39"> Aria-required</label> 
									...
									<input type="checkbox" id="md_checkbox_40" class="arial filled-in chk-col-info" value="Aria-rowindex" />
									<label for="md_checkbox_40"> Aria-rowindex</label> 
									
									<input type="checkbox" id="md_checkbox_41" class="arial filled-in chk-col-info" value="Aria-rowspan" />
									<label for="md_checkbox_41"> Aria-rowspan</label> 
									
									<input type="checkbox" id="md_checkbox_42" class="arial filled-in chk-col-info" value="aria-selected_state" />
									<label for="md_checkbox_42"> Aria-selected (state)</label> 
