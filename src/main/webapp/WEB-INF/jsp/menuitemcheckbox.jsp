						...
						<div class="card mt-30">
							...
							<div class="card-body" >
								<div class="demo-checkbox"
									...
									<input type="checkbox" id="md_checkbox_36" class="arial filled-in chk-col-info" value="Aria-checked_state" />
									<label for="md_checkbox_36">Aria-checked (state)</label> 
									...
									<input type="checkbox" id="md_checkbox_37" class="arial filled-in chk-col-info" value="Aria-posinset" />
									<label for="md_checkbox_37">Aria-posinset</label>
									
									<input type="checkbox" id="md_checkbox_38" class="arial filled-in chk-col-info" value="Aria-readonly" />
									<label for="md_checkbox_38">Aria-readonly</label> 
									...
									<input type="checkbox" id="md_checkbox_39" class="arial filled-in chk-col-info" value="Aria-setsize" />
									<label for="md_checkbox_39">Aria-setsize</label> 
								</div>
							</div>
						</div>
					</div>
