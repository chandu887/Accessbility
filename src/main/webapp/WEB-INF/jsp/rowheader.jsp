						...
						<div class="card mt-30">
							...
							<div class="card-body" >
								<div class="demo-checkbox"
									...
									<input type="checkbox" id="md_checkbox_36" class="arial filled-in chk-col-info" value="Aria-colindex" />
									<label for="md_checkbox_36"> Aria-colindex</label> 
									
									<input type="checkbox" id="md_checkbox_37" class="arial filled-in chk-col-info" value="Aria-colspan" />
									<label for="md_checkbox_37"> Aria-colspan</label> 
									...
									<input type="checkbox" id="md_checkbox_38" class="arial filled-in chk-col-info" value="Aria-expanded_state" />
									<label for="md_checkbox_38"> Aria-expanded (state)</label> 
									...
									<input type="checkbox" id="md_checkbox_39" class="arial filled-in chk-col-info" value="Aria-readonly" />
									<label for="md_checkbox_39">Aria-readonly</label> 
									...
									<input type="checkbox" id="md_checkbox_40" class="arial filled-in chk-col-info" value="Aria-required" />
									<label for="md_checkbox_40"> Aria-required</label>
									...
									<input type="checkbox" id="md_checkbox_41" class="arial filled-in chk-col-info" value="Aria-rowindex" />
									<label for="md_checkbox_41"> Aria-rowindex</label> 
									
									<input type="checkbox" id="md_checkbox_42" class="arial filled-in chk-col-info" value="Aria-rowspan" />
									<label for="md_checkbox_42"> Aria-rowspan</label> 
									
									<input type="checkbox" id="md_checkbox_43" class="arial filled-in chk-col-info" value="aria-selected_state" />
									<label for="md_checkbox_43"> Aria-selected (state)</label> 
								</div>
							</div>
						</div>
					</div>
