						...
						<div class="card mt-30">
							...
							<div class="card-body" >
								<div class="demo-checkbox"
									...
									<input type="checkbox" id="md_checkbox_38" 	class="arial filled-in chk-col-success" value="Aria-colcount" />
									<label for="md_checkbox_38">Aria-colcount</label> 
									...
									<input type="checkbox" id="md_checkbox_39" class="arial filled-in chk-col-info" value="Aria-multiselectable" />
									<label for="md_checkbox_39">Aria-multiselectable</label> 
									
									<input type="checkbox" id="md_checkbox_40" class="arial filled-in chk-col-info" value="Aria-orientation" />
									<label for="md_checkbox_40">Aria-orientation</label> 
									...
									<input type="checkbox" id="md_checkbox_41" class="arial filled-in chk-col-info" value="Aria-readonly" />
									<label for="md_checkbox_41">Aria-readonly</label> 
									...
									<input type="checkbox" id="md_checkbox_42" class="arial filled-in chk-col-info" value="Aria-required" />
									<label for="md_checkbox_42"> Aria-required</label>
									...
									<input type="checkbox" id="md_checkbox_43" class="arial filled-in chk-col-info" value="Aria-rowcount" />
									<label for="md_checkbox_43"> Aria-rowcount</label> 
								</div>
							</div>
						</div>
					</div>
